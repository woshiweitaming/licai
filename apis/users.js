...
//进行兑换
export const exchangeCommodity = (data) => {
	return request({
		url: '/user/exchangeCommodity',
		method: 'post',
		data,
	})
}
...
//帐变
export const getAccountLog = (data) => {
	return request({
		url: '/user/getAccountLog',
		method: 'get',
		data
	})
}
